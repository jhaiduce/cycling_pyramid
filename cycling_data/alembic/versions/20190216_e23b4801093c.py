...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['wxdata_id'], ['weatherdata.id'], name='fk_weatherdata_ride_id'),
    ...
    sa.ForeignKeyConstraint(['id'], ['weatherdata.id'], name='fk_weatherdata_rideweatherdata_id'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_rideweatherdata'))
    )
    op.create_table('stationweatherdata',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('metar', sa.Text(), nullable=True),
    sa.Column('report_time', sa.DateTime(), nullable=True),
    sa.Column('weather', sa.String(length=255), nullable=True),
    sa.ForeignKeyConstraint(['id'], ['weatherdata.id'], name='fk_weatherdata_stationweatherdata_id'),
